          ...
          <ChampionDetailMainContent>
            <div className="main-content-abilities">
              ...
              <div className="main-content-abilities-traits">
                {championDetail.champion_origin
                  ...
                  .map((i) => synergysData.find((s) => s.synergy_name === i))
                  .map((t) => {
                    return (
                      <div
                        key={t.synergy_name}
                        className="main-content-abilities-skill"
                      >
            ...
            <div className="main-content-trait">
              ...
              {championDetail.champion_class
                ...
                .map((t) => synergysData.find((s) => s.synergy_name === t))
                .map((t) => {
                  return (
                    <div
                      key={t.synergy_name}
                      className="main-content-trait-item"
                    >
                      ...
                      <div className="main-content-trait-members">
                        {championsData
                          .filter(
                            (c) =>
                              (c.champion_origin.includes(t.synergy_name) ||
                                c.champion_class.includes(t.synergy_name)) &&
